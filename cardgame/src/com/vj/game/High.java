		...
		high.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(check>Start.n){
					...
					MediaPlayer mp=MediaPlayer.create(High.this, R.raw.aps);
					mp.start();
					Start.n=check;
					Intent it2=new Intent(High.this,High.class);
					startActivity(it2);
					
				}
				else{
					n=check;
					Intent it=new Intent(High.this,GameFinish.class);
					startActivity(it);
		...
		low.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(check<Start.n){
					...
					mp.start();
					Start.n=check;
					Intent it=new Intent(High.this,Low.class);
					startActivity(it);
