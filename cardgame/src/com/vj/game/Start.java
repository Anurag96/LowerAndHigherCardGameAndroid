...
public class Start extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.setTitle("GAME STARTED ");
		
		setContentView(R.layout.start);
		
		n=showRandomNum(1,13);
		tv=(TextView)findViewById(R.id.TextView01);
		sc=(TextView)findViewById(R.id.score2);
		...
		iv.setImageDrawable(r);
    		...
    		high.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					if(check>n){
						...
						MediaPlayer mp=MediaPlayer.create(Start.this, R.raw.aps);
						mp.start();
						n=check;
						Intent it=new Intent(Start.this,High.class);
						startActivity(it);
					}
					else {
						n=check;
						Toast.makeText(getApplicationContext(), "wrong selection", 100).show();
						Intent it=new Intent(Start.this,GameFinish.class);
						startActivity(it);
					}
    		...
    		change.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					if(check!=n){
						n=check;
					Intent itc=new Intent(Start.this,Change.class);
					startActivity(itc);
					}
				}
